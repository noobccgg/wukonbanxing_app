...
Java_com_example_mnnllmdemo_MainActivity_Load_1Models_1A(JNIEnv *env, jobject clazz,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_example_mnnllmdemo_MainActivity_Load_1Models_1B(JNIEnv *env, jobject thiz,
                                                            jobject asset_manager,
                                                            jboolean use_xnnpack) {
    OrtStatus *status;
    OrtAllocator *allocator;
...
Java_com_example_mnnllmdemo_MainActivity_Process_1Texture(JNIEnv *env, jclass clazz) {
...
Java_com_example_mnnllmdemo_MainActivity_Process_1Init(JNIEnv *env, jclass clazz, jint texture_id) {
...
Java_com_example_mnnllmdemo_MainActivity_Run_1YOLO(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT jfloatArray JNICALL
Java_com_example_mnnllmdemo_MainActivity_Run_1Depth(JNIEnv *env, jclass clazz,
                                                       jbyteArray pixel_values) {
    jbyte* pixels = env->GetByteArrayElements(pixel_values, nullptr);
    OrtMemoryInfo *memory_info;
